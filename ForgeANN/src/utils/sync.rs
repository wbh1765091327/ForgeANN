...
use crate::utils::wake_list::WakeList;
...
impl Inner {
    ...
    ///
    /// The maximum number of permits is `usize::MAX >> 3`, and this function will panic if the
    /// limit is exceeded.
...
///
/// ```
/// use forgeann::utils::sync::{Semaphore, TryAcquireError};
///
/// #[monoio::main]
/// async fn main() {
...
/// use std::rc::Rc;
///
/// use forgeann::utils::sync::Semaphore;
///
/// #[monoio::main]
/// async fn main() {
...
impl Semaphore {
    ...
    ///     assert_eq!(
    ///         semaphore2.try_acquire().err(),
    ///         Some(TryAcquireError::Closed)
    ///     )
    /// }
    /// ```
    pub fn close(&self) {
